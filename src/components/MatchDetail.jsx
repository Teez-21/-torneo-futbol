        ...
        <>
          ...
          <div className="detail-awards">
            ...
            <div className="award-item award-gold">
              <span>⭐ MVP Ganador</span>
              <span className="award-name">{winnerMVP}</span>
              <span className="award-pts">+2 pts</span>
            </div>
            <div className="award-item award-silver">
              <span>⭐ MVP Perdedor</span>
              <span className="award-name">{loserMVP}</span>
              <span className="award-pts">+1 pt</span>
            </div>
            <div className={`award-item ${goalsVsWinnerKeeper < 3 ? 'award-gold' : 'award-dim'}`}>
              <span>🧤 Arquero Ganador</span>
              <span className="award-name">{winnerKeeper}</span>
              <span className="award-pts">
                {goalsVsWinnerKeeper < 3 ? '+2 pts' : `${goalsVsWinnerKeeper} goles recibidos`}
              </span>
            </div>
            <div className={`award-item ${goalsVsLoserKeeper < 3 ? 'award-silver' : 'award-dim'}`}>
              <span>🧤 Arquero Perdedor</span>
              <span className="award-name">{loserKeeper}</span>
              <span className="award-pts">
                {goalsVsLoserKeeper < 3 ? '+1 pt' : `${goalsVsLoserKeeper} goles recibidos`}
              </span>
            </div>
          </div>
