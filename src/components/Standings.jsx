  ...
  return (
    <div className="page">
      ...
      <div className="legend">
        ...
        <div className="legend-item"><span className="legend-dot green" />MVP ganador: +2 pts</div>
        <div className="legend-item"><span className="legend-dot dim" />MVP perdedor: +1 pt</div>
        <div className="legend-item"><span className="legend-dot green" />Arquero ganador &lt;3 goles: +2 pts</div>
        <div className="legend-item"><span className="legend-dot dim" />Arquero perdedor &lt;3 goles: +1 pt</div>
      </div>
